...
const input={borderWidth:1 as const,borderColor:C.border,borderRadius:14,padding:15,marginTop:14,fontSize:22,color:C.ink,backgroundColor:C.card,textAlign:'center',letterSpacing:5};
